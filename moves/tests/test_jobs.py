...
class TestJobExecutions:
    ...
    def test_job_nav_snapshot_success(self, mock_logger, mock_get_users, seeded_db: Database) -> None:
    ...
    @patch("engine.jobs._get_active_user_ids")
    @patch("engine.jobs.logger")
    def test_job_nav_snapshot_exception(self, mock_logger, mock_get_users, seeded_db: Database) -> None:
    ...
    def test_job_news_scan_success(self) -> None:
        ...
        from engine.jobs import job_news_scan
    ...
    def test_job_signal_scan_success(self, seeded_db: Database) -> None:
        ...
        from engine.jobs import job_signal_scan
    ...
    @patch("engine.jobs._get_active_user_ids")
    @patch("engine.jobs.logger")
    def test_job_whatif_update_success(self, mock_logger, mock_get_users, seeded_db: Database) -> None:
