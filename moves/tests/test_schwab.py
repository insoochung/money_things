...
class TestGetPositions:
    ...
    async def test_returns_positions(self, broker, mock_client):
    ...
    async def test_handles_api_error(self, broker, mock_client):
...
class TestGetAccountBalance:
    ...
    async def test_returns_balance(self, broker, mock_client):
    ...
    async def test_handles_error(self, broker, mock_client):
...
class TestPlaceOrder:
    ...
    async def test_place_market_buy(self, mock_equity, broker, mock_client):
    ...
    async def test_place_order_failure(self, broker, mock_client):
...
class TestGetOrderStatus:
    ...
    async def test_filled_status(self, broker, mock_client):
    ...
    async def test_cancelled_status(self, broker, mock_client):
...
class TestCancelOrder:
    ...
    async def test_cancel_success(self, broker, mock_client, mock_db):
    ...
    async def test_cancel_failure(self, broker, mock_client):
...
class TestPreviewOrder:
    ...
    async def test_preview_with_price(self, mock_price, broker):
    ...
    async def test_preview_no_price(self, mock_price, broker):
...
class TestRefreshToken:
    ...
    async def test_refresh_success(self, mock_auth, broker, mock_db):
    ...
    async def test_refresh_failure(self, mock_auth, broker):
...
class TestSyncPositions:
    ...
    async def test_sync_detects_discrepancy(self, broker, mock_client, mock_db):
