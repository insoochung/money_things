...
class TestNewsScanner:
    ...
    def test_news_scanner_initialization(self, seeded_db: Database) -> None:
        ...
        with patch("engine.news_scanner.NewsValidator") as MockValidator:
            ...
            assert scanner.validator == MockValidator.return_value
    ...
    def test_news_scanner_with_none_engines(self, seeded_db: Database) -> None:
        ...
        with patch("engine.news_scanner.NewsValidator") as MockValidator:
            scanner = NewsScanner(seeded_db, None, None)  # type: ignore
