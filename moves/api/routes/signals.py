...
class SignalResponse(BaseModel):
    ...
    thesis_id: int | None = Field(None, description="Linked thesis")
    thesis_title: str | None = Field(None, description="Thesis title")
    thesis_status: str | None = Field(None, description="Thesis status")
    thesis_conviction: float | None = Field(None, description="Conviction score")
    ...
    size_pct: float | None = Field(None, description="Position size %")
    funding_plan: str | None = Field(None, description="Funding plan")
    status: str = Field(..., description="pending/approved/rejected")
    telegram_msg_id: str | None = Field(None, description="Telegram message")
    created_at: str = Field(..., description="Created at")
    decided_at: str | None = Field(None, description="Decided at")
    expired_at: str | None = Field(None, description="Expires at")
